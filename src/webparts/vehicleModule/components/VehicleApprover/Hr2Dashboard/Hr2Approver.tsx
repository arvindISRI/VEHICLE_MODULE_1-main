...
export default class HR2ApproveVehicle extends React.Component<IVehicleModuleProps, any> {
  ...
  public BtnRejectRequest = async () => {
    if (this.state.ExpenseDetails.HR2Remarks == "" || this.state.ExpenseDetails.HR2Remarks == null || this.state.ExpenseDetails.HR2Remarks == undefined) {
    ...
    return (
      <div >
        ...
        <div className='text-center'>
          <PrimaryButton onClick={() => this.BtnApproveHR2Request()} >Approve</PrimaryButton>
